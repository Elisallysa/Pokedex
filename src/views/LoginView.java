...
public class LoginView {
	...
	// Método que configura los Listeners de los botones de la interfaz gráfica.
	public void configureUIListeners() {

		/**
		 * El botón Login (Iniciar sesión) permite acceder a la Pokédex tras ingresar el
		...
		/**
		 * El campo de texto de contraseña permite acceder a la Pokédex tras pulsar la
		 * tecla ENTER (si el nombre de usuario + contraseña son correctos).
		 */
		...
		/**
		 * El campo de texto del nombre de usuario permite acceder a la Pokédex tras
		 * pulsar la tecla ENTER (si el nombre de usuario + contraseña son correctos).
		 */
		...
		/**
		 * El botón SignIn (Registrarse) permite al usuario crear un nombre de usuario y
		 * contraseña para acceder a la Pokédex.
		 */
	...
	/**
	 * Método que obtiene el texto del campo de texto del nombre de usuario y la
	...
	public void login() {
		 ...
		 * Pokédex. Si no, lanza un mensaje que informa que el nombre de usuario o
